...
export default function AgroTwinPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-green-50 to-green-100">
      <main className="text-center max-w-2xl mx-auto px-4">
        ...
        <Link href="/agrotwin/dashboard" prefetch={true}>
          <button className="pointer-events-auto cursor-pointer bg-green-600 px-8 py-6 text-lg text-white hover:bg-green-700 transition-colors rounded-lg">
            View Dashboard
